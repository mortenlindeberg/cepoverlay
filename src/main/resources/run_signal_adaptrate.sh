...
for sleep in 50 100 150
do
  f=$((400 / sleep))
  exp_name=exp_signal-adapt_$f_$sleep
  sources=A1:1:10.0.0.1:2079:10.0.0.1:1077:$sleep:0,A1:1:10.0.0.1:2080:10.0.0.4:1083:10:0,B1:2:10.0.0.2:2081:10.0.0.4:1083:500:0
